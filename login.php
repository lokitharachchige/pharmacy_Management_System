...
<div id="main-wrapper">
  <div class="unix-login">
    <div class="container-fluid" style="background-image: url('assets/uploadImage/Logo/banner.jpg'); background-color: #ffffff; background-size: cover">
      <div class="row">
        <div class="col-md-4">
            ...
            <div class="login-form">
              ...
              <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm" class="row">
                <div class="form-group col-md-12">
                  <label>Email</label>
                  <input type="text" name="email" id="email" class="form-control" placeholder="Enter your email" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="Invalid email address" required="">
                </div>
                <div class="form-group col-md-12">
                ...
                <div class="forgot-phone col-md-6 text-right">
                  <a href="forgot_password.php" class="text-right f-w-600 text-gray">Forgot Password?</a>
                </div>
                <div class="col-md-12">
